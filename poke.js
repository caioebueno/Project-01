...
var url = "https://www.googleapis.com/youtube/v3/videos?id=-PlAg8R9TG4&key=AIzaSyCJ1iJthOd27F_OOEKx_-hJ8S07jCBDZB0&part=snippet,statistics";
  ...
  $("#startBtn").on("click", function start(){
    ...
    var queryURL2 = "https://pokeapi.co/api/v2/pokemon/charizard"
      ...
      function moveSprite(){
        ...
        document.addEventListener("keydown", function(e){
          ...
          if(e.key == "ArrowDown"){
            ...
            console.log(style.borderBottom.indexOf("solid"));
            if(style.borderBottom.indexOf("solid") == -1){
          ...
          if(e.key == "ArrowUp"){
            ...
            if(style.borderTop.indexOf("solid") == -1){
          ...
          if(e.key == "ArrowRight"){
            ...
            if(style.borderRight.indexOf("solid") == -1){
          ...
          if(e.key == "ArrowLeft"){
            ...
            if(style.borderLeft.indexOf("solid") == -1){
